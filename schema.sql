-- ============================================================
-- English Coach — D1 schema (Cloudflare SQLite)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS users (
  ...
  tier_expires  INTEGER,                      -- unix ms
  stripe_customer_id TEXT,
  apple_sub_id  TEXT,
  -- Settings
  notify_enabled INTEGER DEFAULT 0,
  api_key_hint  TEXT,                         -- last 4 chars of custom API key
  -- Timestamps
...
-- ── Sessions (refresh tokens + KV cache key) ────────────────
...
CREATE TABLE IF NOT EXISTS pet_state (
  ...
  owned_pets      TEXT,           -- JSON array
  owned_items     TEXT,           -- JSON array
  furniture       TEXT,           -- JSON array
  last_fed_at     INTEGER,
...
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  source          TEXT,                  -- stripe | apple | manual
  external_id     TEXT,                  -- stripe sub id / apple sub id
...
-- ── Scene stats (count per scene for stats screen) ───────────
